...
vim.keymap.set(
    "n",
    "<leader>mb",
    ":w<CR>:silent make! -C build | redraw! | cw<CR>",
    { noremap = true, silent = true }
)
...
vim.keymap.set(
    "n",
    "<leader>md",
    ":w<CR>:silent make! debug | redraw! | cw<CR>",
    { noremap = true, silent = true }
)
...
vim.keymap.set(
    "n",
    "<leader>mo",
    ':cex system("make run")<CR>:copen<CR>',
    { noremap = true, silent = true }
)
...
vim.keymap.set(
    "n",
    "<C-@>",
    ":!tmux-sessionizer<CR><CR>",
    { silent = true, desc = "Change tmux session" }
)
